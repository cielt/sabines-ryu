<div id="sidebar-book" class="hentry sidebar-col tile-feature">
	...
	<div class="sidebar-info feature-info">
		<h2 class="entry-title feature-title h-sans">Among Murderers: Life After Prison</h2>
		<span class="tile-meta">University of California Press, 2013</span>
		<blockquote class="sidebar-quote">
			<p>&ldquo;A deeply compassionate book that poses urgent questions about the end product of imprisonment and the social thirst for vengeance.&rdquo;</p>
			<cite class="author"><em>Kirkus Review</em></cite>
		</blockquote>
